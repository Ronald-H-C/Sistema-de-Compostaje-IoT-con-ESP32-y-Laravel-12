                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="block w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-700 font-medium">
                                {{ $message->full_name }}
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <div class="block w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-green-700 font-medium">
                                {{ $message->email }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="block w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-800 font-medium">
                            {{ $message->subject }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="block w-full p-4 rounded-lg border border-gray-200 bg-gray-50 text-gray-600 whitespace-pre-wrap"> {{-- whitespace-pre-wrap para respetar saltos de línea --}}
                            {{ $message->message }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="state" name="state" required
                            ...
                            {{-- Asumiendo 0=Recepcionado(Archivado), 1=Pendiente --}}
                            <option value="0" {{ old('state', $message->state) == 0 ? 'selected' : '' }}>Recepcionado (Archivado)</option>

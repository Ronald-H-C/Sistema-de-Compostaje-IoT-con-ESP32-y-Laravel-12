            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav pt-4">
                        ...
                        <a class="nav-link text-white" href="{{ route('compost') }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>
                ...
                <div class="sb-sidenav-footer border-t border-gray-700 px-4 py-3 mt-auto">
                <div class="small text-gray-400">Bienvenid@:</div>

                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" required
                                      class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm p-2.5">{{ old('description') }}</textarea>
                        </div>
                    </div>

        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <p class="text-green-600 font-medium mb-4">Desarrollador</p>
                    <p class="text-gray-600 mb-4">
                        Responsable del desarrollo de la plataforma web, dashboard de visualización de datos.
                    </p>
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-500 hover:text-green-600">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <!-- Miembro 3 - Cesar Romulo Vasquez Soto -->
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div class="h-64 bg-gray-200 overflow-hidden">
                    <img src="{{ asset('img/imgCesar.png') }}"
                        alt="Cesar Romulo Vasquez Soto" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">Cesar Romulo Vasquez Soto</h3>
                    <p class="text-green-600 font-medium mb-4">Desarrollador de Aplicaciones Android</p>
                    <p class="text-gray-600 mb-4">
                        Encargado del diseño y desarrollo de aplicación móvil, optimizando el rendimiento y la
                        experiencia de usuario intuitiva en sistema Android.
                    </p>
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-500 hover:text-green-600">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
